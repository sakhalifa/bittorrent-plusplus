...
void string_to_list_key(char *string, char **list, int *size, const char *separator)
{
...
void string_to_list_file(char *string, struct file *files[], int *size, const char *separator)
{
